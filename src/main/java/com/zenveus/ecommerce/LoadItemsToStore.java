...
@WebServlet(name = "LoadItemsToMenuPage", value = "/load-items-to-store")
public class LoadItemsToStore extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("LoadItemsToMenuPage.doGet sending redirect to store.jsp");
